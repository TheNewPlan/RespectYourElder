...
class PromotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post promotions_url, params: { promotion: { p_desc: @promotion.p_desc, p_end: @promotion.p_end, p_image: @promotion.p_image, p_start: @promotion.p_start, p_title: @promotion.p_title } }
    end
  ...
  test "should update promotion" do
    patch promotion_url(@promotion), params: { promotion: { p_desc: @promotion.p_desc, p_end: @promotion.p_end, p_image: @promotion.p_image, p_start: @promotion.p_start, p_title: @promotion.p_title } }
